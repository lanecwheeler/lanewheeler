        ...
        data() {
            return {
                ...
                majorProjects: [ {
                        ...
                        desc: 'I was the lead developer on a telehealth platform focused on getting people their medical marijuana cards and physician’s ' +
                            'medical cannabis certifications/recommendations as simply and easily as possible. The site is comprised' +
                            'of an appointment scheduling service to the public (integrated with Acuity), and a authenticated portal for ' +
                            'Patients and Doctors to communicate, and for Doctors approve and automatically generate marijuana recommendations ' +
